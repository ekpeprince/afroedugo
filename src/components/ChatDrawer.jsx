        ...
        >
          ...
          {previewAudioUrl ? (
            <button 
              ...
              disabled={isUploading}
              className="w-12 h-12 flex-shrink-0 bg-primary hover:bg-primary-light text-white rounded-full flex items-center justify-center shadow-md shadow-primary/20 transition-all scale-100 disabled:opacity-50"
            >
              {isUploading ? (
