      ...
      <header className="p-3 sm:p-4 bg-[#008069] dark:bg-[#202c33] text-white flex items-center gap-4 sticky top-0 z-20 shadow-sm transition-colors duration-300">
        ...
        <div className="flex items-center gap-3 cursor-pointer w-full">
          ...
          <div className="flex items-center gap-4 ml-auto">
            <button onClick={() => alert("Audio Calling is coming soon!")} className="hover:opacity-80 transition-opacity" title="Audio Call">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
              </svg>
            </button>
            <button onClick={() => alert("Video Calling is coming soon!")} className="hover:opacity-80 transition-opacity" title="Video Call">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <polygon points="23 7 16 12 23 17 23 7"></polygon><rect x="1" y="5" width="15" height="14" rx="2" ry="2"></rect>
              </svg>
            </button>
            <button onClick={() => alert("More options coming soon!")} className="hover:opacity-80 transition-opacity" title="More options">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
