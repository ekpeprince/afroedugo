...
const AuthScreen = ({ onBack, onAuthSuccess }) => {
  ...
  const { login, signup, loading, error, loginWithGoogle, loginWithTikTok } = useAuth();
      ...
      <form onSubmit={handleSubmit} className="space-y-6 flex-grow">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            ...
            <span className="font-black text-xs uppercase tracking-widest text-gray-700">Google</span>
          </button>
          ...
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
              <path d="M12.525.02c1.31 0 2.59.32 3.73.92V6h-3.73v3.73h3.73v3.73c2.06 0 3.72-1.66 3.72-3.72V0h3.73v3.73h1.86v3.73h-1.86v3.73c0 3.09-2.51 5.6-5.6 5.6-3.09 0-5.6-2.51-5.6-5.6V0z"/>
            </svg>
            <span className="font-black text-xs uppercase tracking-widest text-white">TikTok</span>
          </button>
        </div>
      </form>
